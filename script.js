...
async function openCard(id) {
  ...
  // Set image caption (used in image tab)
  ...
  // Fetch image async — updates image tab when ready (does NOT show in info tab)
  fetchCardImage(card).then(imgUrl => {
    _currentCardImageUrl    = imgUrl || null;
    _currentCardImageLoaded = true;

    // If the image tab is already open, update it immediately
